              ...
              Padding(
                  ...
                  child: Stack(
                    ...
                    children: [
                      ...
                      Obx(() {
                        if (mainController.selectedImagePath.isNotEmpty) {
                          return Positioned(
                              top: -25,
                              right: 5,
                              child: IconButton(
                                ...
                                onPressed: () {
                                  mainController.clearSelectedImage();
                                },
                              ));
                        } else {
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              mainController.switchStatus();
                            },
                          ),
                        ),
                        const SizedBox(height: 10.0),
                        Obx(() {
                          if (mainController.buttonCowStatus.value) {
                            return Column(
                              children: [
                                TextFormField(
                                  onChanged: (value) {
                        ...
                        Obx(() {
                          return Column(
                            children: [
                              TextFormField(
                                  controller: mainController.dateTextController,
                                  onChanged: (value) {
                                  ...
                                  readOnly: true,
                                  onTap: () {
                                    mainController.selectedDate(context);
                                  }),
                              Transform(
                                ...
                                child: Padding(
                                  ...
                                  child: Align(
                                    ...
                                    child: Text(
                                      "อายุ: ${mainController.countBirthDate.value} วัน",
                                    ),
                                  ),
                                ),
                              ),
                          ...
                          return Row(
                            children: [
                              ElevatedButton(
                                style: ElevatedButton.styleFrom(
                                  backgroundColor:
                                      mainController.genderType.value ==
                                              'female'
                                          ? Colors.pink[400]
                                          : Colors.grey,
                                  shape: RoundedRectangleBorder(
                                ...
                                onPressed: () {
                                  mainController.switchGender('female');
                              ...
                              ElevatedButton(
                                style: ElevatedButton.styleFrom(
                                  backgroundColor:
                                      mainController.genderType.value == 'male'
                                          ? Colors.blue[400]
                                          : Colors.grey,
                                  shape: RoundedRectangleBorder(
                                    borderRadius:
                                ...
                                onPressed: () {
                                  mainController.switchGender('male');
                          ...
                          return Center(
                            child: Wrap(
                              ...
                              children: [
                                ElevatedButton(
                                  style: ElevatedButton.styleFrom(
                                    backgroundColor: mainController.buttonStatus
                                                .toString() ==
                                            'breeds5'
                                        ? Colors.blue[400]
                                        : Colors.grey[500],
                        ...
                        const SizedBox(height: 20.0),
                        Obx(() {
                          if (mainController.buttonStatus.isNotEmpty) {
                            return Row(
                              children: [
                                Flexible(
                                  flex: 2,
                                ...
                                Flexible(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: mainController.showRatio.isTrue
                                          ? Row(
                                              mainAxisAlignment:
                                                  MainAxisAlignment.center,
                                              children: [
                              ...
                              return AlertDialog(
                                ...
                                content: SingleChildScrollView(
                                  child: Column(
                                    children: [
                                      Text(
                                          'แม่โคที่คลอด: ${submitForm.cowMother}'),
                                      Text(
                                          'พ่อพันธุ์: ${submitForm.cowFather}'),
